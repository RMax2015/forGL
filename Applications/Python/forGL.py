...
class Main:
    ...
    def main():
        ...
        try:
            ...
            _this1 = _this
            _this1._out.flush()
            version = "forGL v0.0.2 Prototype in "
    ...
    def initRunForGL():
        ...
        def _hx_local_2():
            ...
            return _hx_local_1
        _hx_local_3 = Main
        _hx_local_4 = _hx_local_3.text_line
        _hx_local_3.text_line = (_hx_local_4 + Math.floor(Reflect.field(Math,"fabs")(_hx_local_2())))
        _hx_local_3.text_line
        _hx_local_5 = Main
        _hx_local_6 = _hx_local_5.text_line
        _hx_local_5.text_line = (_hx_local_6 + 1)
        _hx_local_6
        def _hx_local_8():
            _hx_local_7 = init_result
        ...
        _hx_local_10
        _hx_local_11 = Main
        _hx_local_12 = _hx_local_11.text_line
        _hx_local_11.text_line = (_hx_local_12 + 1)
        _hx_local_12
...
class TestUI:
    ...
    @staticmethod
    def simple():
        haxe_Log.trace("Hello ",_hx_AnonObject({'fileName': "src/Main.hx", 'lineNumber': 693, 'className': "TestUI", 'methodName': "simple"}))
            ...
            if (0 <= dictIdx):
                ...
                def _hx_local_16():
                    ...
                    if (Std.isOfType(_hx_local_15,Int) or ((_hx_local_15 is None))):
                        ...
                        raise "Class cast error"
                    return _hx_local_15
                if ((0 != _hx_local_16()) or ((0 < len(_hx_dict.addWord_msg)))):
                            ...
                            if ((token_lower != prev_replace) and ((token_lower != no_replace))):
                                ...
                                while (not ans_done):
                                    ...
                                    if ((89 == char_code) or ((121 == char_code))):
                                        #  User has selected another SIMILAR Word to run here.
                                        #  
        ...
        if (0 < len(runStack)):
            ...
            while (i < _hx_len):
                ...
                if (4 == _hx_type):
                        ...
                        if (10 == (runStack[i] if i >= 0 and i < len(runStack) else None).token_noun_data):
                            ...
                            def _hx_local_43():
                                ...
                                if (Std.isOfType(_hx_local_42,Int) or ((_hx_local_42 is None))):
                                    ...
                                    raise "Class cast error"
                                return _hx_local_42
                            forGL_ForGL_ui.error(("INTERNAL ERROR: wrong token_noun_data value " + Std.string(_hx_local_43())),1)
                        if show_words:
                            lines_added = (lines_added + 1)
                else:
                    if show_words:
                    ...
                    if text_str:
                        _hx_local_45 = self
                        _hx_local_46 = _hx_local_45.words_table_text
                        _hx_local_45.words_table_text = (("null" if _hx_local_46 is None else _hx_local_46) + "\n")
                        _hx_local_45.words_table_text
                    if show_words:
                        lines_added = (lines_added + 1)
                i = (i + 1)
        return lines_added
...
class forGL_ForGL_Run:
    ...
    _hx_methods = ["init", "cleanUp", "dataStackToString", "opStackToString", "nounStackToString", "dataStackOut", "viewDataOpNouns", "show1Data", "viewRepeatCount", "runAssignment", "addQuotes", "trimQuotes", "runMath1Data", "runStr2Data", "runMath2Data", "runOperators", "procCall", "run", "runDef", "runDef_End", "runInterpreter"]
    ...
    def runMath2Data(self,rStack,dStack,oStack,nStack,after_expression):
        ...
        if self.show_details:
            ...
            _hx_local_19 = self
            _hx_local_20 = _hx_local_19.run_text_line
            _hx_local_19.run_text_line = (_hx_local_20 + 1)
            _hx_local_20
        if self.show_stacks:
            self.viewDataOpNouns(rStack,dStack,oStack,nStack,self.dataOpNoun_text_line)
        return 0
    ...
    def procCall(self,rStack,dStack,oStack,nStack):
        pass
        ...
        try:
            ...
            if (0 < len(self.export_as_code_log)):
                ...
                while (i < len(self.export_as_code_log)):
                    forGL_ForGL_ui.msg((self.export_as_code_log[i] if i >= 0 and i < len(self.export_as_code_log) else None),2,True)
                    i = (i + 1)
                forGL_ForGL_ui.msg("\n")
                #  
                #  Create & Write out Export file
                #  
                expAs = forGL_NLExportAs()
                expRet = expAs.init(self.export_as_code_log)
        except BaseException as _g:
            None
            e = haxe_Exception.caught(_g).unwrap()
    ...
    def runDef(self,def_to_run,textLine):
        ...
        try:
            ...
            if self.export_as_code:
                _this = self.export_as_code_log
                x = ("# forGL Verb after changes for Export as Code  " + HxOverrides.stringOrNull(self.export_as_code_verb_name))
                _this.append(x)
                _this = self.export_as_code_log
                _this.append(colored_text_no_color)
                _this = self.export_as_code_log
                x = ("# forGL Verb exact Syntax table  " + HxOverrides.stringOrNull(self.export_as_code_verb_name))
                _this.append(x)
                _this = self.export_as_code_log
                x = self.nl_Parse.words_table_text
                _this.append(x)
            forGL_ForGL_ui.msg("\n")
            _hx_local_48 = self
            ...
            if self.show_stacks:
                ...
                _hx_local_56.run_text_line = (_hx_local_57 + 3)
                _hx_local_56.run_text_line
            if self.repeat_found:
                repeat_text_line = self.run_text_line
                forGL_ForGL_ui.msg("\n")
                _hx_local_58 = self
            ...
            while (not intp_done):
                ...
                while (ip < len(self.runStack)):
                        ...
                        if (not local_inference):
                            if (0 == (self.runStack[runIdx] if runIdx >= 0 and runIdx < len(self.runStack) else None).token_noun_data):
                                ...
                                if (0 == (self.runStack[runIdx] if runIdx >= 0 and runIdx < len(self.runStack) else None).token_noun_data):
                                    ...
                                    if (0 < len(self.assignStack)):
                                        ...
                                        _hx_local_79
                                        _hx_local_80 = self
                                        _hx_local_81 = _hx_local_80.run_text_line
                                        _hx_local_80.run_text_line = (_hx_local_81 + 1)
                                        _hx_local_81
                                        _hx_local_82 = self
                            ...
                            if (not (((((ip + 1) < ((len(self.runStack) - 1))) and ((2 == python_internal_ArrayImpl._get(self.runStack, (ip + 1)).token_type))) and ((34 == python_internal_ArrayImpl._get(self.runStack, (ip + 1)).token_op_means))))):
                                if (8 == (self.runStack[runIdx] if runIdx >= 0 and runIdx < len(self.runStack) else None).token_noun_data):
                                    ...
                                    _this5.append(x2)
                        _hx_local_94 = self
                        _hx_local_95 = _hx_local_94.steps_done
                        _hx_local_94.steps_done = (_hx_local_95 + 1)
                        _hx_local_95
                        ip = (ip + 1)
                        continue
                    apply_op = False
                    if (2 == (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).token_type):
                        ...
                        if ((((45 == op_to_do) or ((46 == op_to_do))) or ((47 == op_to_do))) or ((48 == op_to_do))):
                            ...
                            if (0 < len(self.opStack)):
                                ...
                                def _hx_local_100():
                                    _hx_local_99 = ops_result
                                    if (Std.isOfType(_hx_local_99,Int) or ((_hx_local_99 is None))):
                                        _hx_local_99
                                    else:
                                        raise "Class cast error"
                                    return _hx_local_99
                            ...
                            if (((32 == op_to_do) or ((33 == op_to_do))) or ((34 == op_to_do))):
                                if (33 == op_to_do):
                                    ...
                                    if (((7 != python_internal_ArrayImpl._get(self.runStack, (ip + 1)).token_type) and ((0 != python_internal_ArrayImpl._get(self.runStack, (ip + 1)).token_type))) and ((6 != python_internal_ArrayImpl._get(self.runStack, (ip + 1)).token_type))):
                                        ...
                                        _hx_local_101 = self
                                        _hx_local_102 = _hx_local_101.run_text_line
                                        _hx_local_101.run_text_line = (_hx_local_102 + 1)
                                        _hx_local_102
                                        self.intp_return_result = -4
                                        break
                                    if (0 == len(self.dataStack)):
                                    ...
                                    if (2 == python_internal_ArrayImpl._get(self.runStack, (ip + 2)).token_type):
                                        ...
                                        ip = (ip + 2)
                                    _hx_local_111 = self
                                    _hx_local_112 = _hx_local_111.steps_done
                                    _hx_local_111.steps_done = (_hx_local_112 + 1)
                                    _hx_local_112
                                    continue
                                else:
                                ...
                                _this12.append(x4)
                                _hx_local_114 = self
                                _hx_local_115 = _hx_local_114.steps_done
                                _hx_local_114.steps_done = (_hx_local_115 + 1)
                                _hx_local_115
                                ip = (ip + 1)
                                continue
                            elif (31 == op_to_do):
                                ...
                                if (18 == op_to_do):
                                    ...
                                    if (0 < len(self.opStack)):
                                        ...
                                        def _hx_local_121():
                                            _hx_local_120 = ops_result1
                                            if (Std.isOfType(_hx_local_120,Int) or ((_hx_local_120 is None))):
                                                _hx_local_120
                                            else:
                                                raise "Class cast error"
                                            ...
                                            if (((("for" == choice_name) or (("if" == choice_name))) or (("switch" == choice_name))) or (("while" == choice_name))):
                                                if (("if" == choice_name) or (("while" == choice_name))):
                                                    ...
                                                    if ((0 == len(self.dataStack)) or ((10 != python_internal_ArrayImpl._get(self.dataStack, (len(self.dataStack) - 1)).data_type))):
                                                        ...
                                                        _hx_local_128.run_text_line = (_hx_local_129 + self.nl_Parse.showWordsTable(self.runStack,True,True,False))
                                                        _hx_local_128.run_text_line
                                                        self.intp_return_result = -4
                                                        break
                                                    ...
                                                    _hx_local_131.run_text_line = (_hx_local_132 + 1)
                                                    _hx_local_132
                                    ...
                                    if (0 < len(self.opStack)):
                                        ...
                                        def _hx_local_136():
                                            _hx_local_135 = ops_result2
                                            if (Std.isOfType(_hx_local_135,Int) or ((_hx_local_135 is None))):
                                                _hx_local_135
                                            else:
                                                raise "Class cast error"
                                ...
                                if ((26 == op_to_do) or ((27 == op_to_do))):
                                    if (26 == op_to_do):
                                        ...
                                        if (0 < len(self.opStack)):
                                            ...
                                            def _hx_local_138():
                                                _hx_local_137 = ops_result3
                                                if (Std.isOfType(_hx_local_137,Int) or ((_hx_local_137 is None))):
                                                    _hx_local_137
                                                else:
                                                    raise "Class cast error"
                                        ...
                                        if (0 < (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).token_int):
                                            ...
                                            _hx_local_141 = self
                                            _hx_local_142 = _hx_local_141.steps_done
                                            _hx_local_141.steps_done = (_hx_local_142 + 1)
                                            _hx_local_142
                                            continue
                                        if (0.0 < (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).token_float):
                                            ...
                                            _hx_local_144 = self
                                            _hx_local_145 = _hx_local_144.steps_done
                                            _hx_local_144.steps_done = (_hx_local_145 + 1)
                                            _hx_local_145
                                            continue
                                else:
                                    ...
                                    def _hx_local_147():
                                        _hx_local_146 = ops_result4
                                        if (Std.isOfType(_hx_local_146,Int) or ((_hx_local_146 is None))):
                                            _hx_local_146
                                        else:
                                            raise "Class cast error"
                    ...
                    if (self.show_details and ((5 != (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).token_type))):
                        ...
                        _hx_local_156 = self
                        _hx_local_157 = _hx_local_156.run_text_line
                        _hx_local_156.run_text_line = (_hx_local_157 + 1)
                        _hx_local_157
                        _hx_local_158 = self
                        _hx_local_159 = _hx_local_158.run_text_line
                        _hx_local_158.run_text_line = (_hx_local_159 + 1)
                        _hx_local_159
                    if (4 == (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).token_type):
                        ...
                        _hx_local_162.run_text_line = (_hx_local_163 + self.nl_Parse.resolveTokens(verb_tokens,self.nlDict,self.runStack,self.run_verbose))
                        _hx_local_162.run_text_line
                        self.repeat_found = self.nl_Parse.repeat_verb_found
                        if (self.nl_Parse.left_groups != self.nl_Parse.right_groups):
                            ...
                            _hx_local_165
                            _hx_local_166 = self
                            _hx_local_167 = _hx_local_166.run_text_line
                            _hx_local_166.run_text_line = (_hx_local_167 + 1)
                            _hx_local_167
                        self.nl_Parse.resolveAssigns(self.runStack)
                        choice_result = -11
                        if self.export_as_code:
                            ...
                            choice_result = self.nl_Parse.resolveChoice(self.runStack)
                        def _hx_local_169():
                            _hx_local_168 = choice_result
                            if (Std.isOfType(_hx_local_168,Int) or ((_hx_local_168 is None))):
                                _hx_local_168
                            else:
                                raise "Class cast error"
                        ...
                        if (((self.show_words_table or self.export_as_code)) and ((0 < len(self.runStack)))):
                            ...
                            _hx_local_170.run_text_line = (_hx_local_171 + self.nl_Parse.showWordsTable(self.runStack,self.show_words_table,False,self.export_as_code))
                            _hx_local_170.run_text_line
                        if self.export_as_code:
                            j = 0
                            exp_text = ""
                        ...
                        if ("repeat" == (self.runStack[ip] if ip >= 0 and ip < len(self.runStack) else None).internal_token):
                            ...
                            if (self.repeat_limit < 0):
                                ...
                                if (self.repeat_limit < 0):
                                    self.repeat_limit = 0
                            _hx_local_179 = self
                            _hx_local_180 = _hx_local_179.repeat_count
                            _hx_local_179.repeat_count = (_hx_local_180 + 1)
                            _hx_local_180
                            ...
                            while (i >= 0):
                                ...
                                if showing:
                                    ...
                                    _hx_local_193 = self
                                    _hx_local_194 = _hx_local_193.run_text_line
                                    _hx_local_193.run_text_line = (_hx_local_194 + 1)
                                    _hx_local_194
                                i = (i - 1)
                    ip = (ip + 1)
                #  
                ...
                if (self.intp_ip >= len(self.runStack)):
                    break
                def _hx_local_198():
                    _hx_local_197 = self.intp_return_result
                    if (Std.isOfType(_hx_local_197,Int) or ((_hx_local_197 is None))):
                        _hx_local_197
                    else:
                        raise "Class cast error"
...
class forGL_data_ForGL_toml:
    ...
    def __init__(self):
        ...
        strLen = len("\t")
        self.ws_chars = [tmp, (-1 if (((strLen == 0) or ((0 >= strLen)))) else HxString.charCodeAt("\t",0))]
        self.data_call_count = 0
